...
# and instance methods are methods that are called on an instance of a class.
...
class AboutClassMethods < Neo::Koan
  ...
  def test_you_can_define_methods_on_individual_objects
    # To define method on individual object, prefix the method name
    # with 'object_name.'
    fido = Dog.new
    def fido.wag
      :fidos_wag
  ...
  def test_classes_and_instances_do_not_share_instance_variables
    ...
    assert_equal nil, Dog.name # instance and class vars can't overlap
  end
