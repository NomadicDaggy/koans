...
class AboutTrueAndFalse < Neo::Koan
  ...
  def test_everything_else_is_treated_as_true
    ...
    assert_equal :true_stuff, truth_value([]) # also empty arrays
    assert_equal :true_stuff, truth_value({}) # and empty hashes
    assert_equal :true_stuff, truth_value("Strings")
    assert_equal :true_stuff, truth_value("") # and empty strings
  end
