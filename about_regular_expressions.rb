...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_question_mark_means_optional
    ...
    # the question mark cares only about one character before it
  ...
  # THINK ABOUT IT:
  #
  # We say that the repetitions operators above are "greedy."
  #
  # Why?
  #
  # They return the longest possible result string...?
  ...
  def test_slash_s_is_a_shortcut_for_a_whitespace_character_class
    # \t and \n are also whitespace character classes
    assert_equal " \t\n", "space: \t\n"[/\s+/]
  end
  ...
  def test_parentheses_also_capture_matched_content_by_number
    # number denotes first, second, third word...
  ...
  def test_scan_is_like_find_all
    # hyphenated words are counted seperately
    assert_equal ["one", "two", "three"], "one two-three".scan(/\w+/)
  end

  # $1[0,1] evaluates to the first character of the string $1, which contains
  # the contents of the first capturing group of the last matched regex.
