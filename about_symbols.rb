...
class AboutSymbols < Neo::Koan
  ...
  def test_symbols_can_be_dynamically_created
    # there has to be a space before the comma, otherwise
    # ruby interprets the comma to be included in the symbol.
  ...
  #
  # if you dynamically create lots of symbols, you are allocating
  # a lot of memory that can't be freed until your program ends.
  # You should only dynamically create symbols (using string.to_sym)
